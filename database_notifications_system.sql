...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  INDEX idx_notifications_equb (equb_settings_id),
  CONSTRAINT fk_notifications_admin FOREIGN KEY (created_by_admin_id) REFERENCES admins(id) ON DELETE SET NULL,
  CONSTRAINT fk_notifications_equb FOREIGN KEY (equb_settings_id) REFERENCES equb_settings(id) ON DELETE SET NULL
